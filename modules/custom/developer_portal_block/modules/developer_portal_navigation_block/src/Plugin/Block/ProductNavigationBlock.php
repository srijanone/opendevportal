...
namespace Drupal\developer_portal_navigation_block\Plugin\Block;
...
use Drupal\developer_portal_block\ApiProducts;
...
class ProductNavigationBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('developer_portal_block.products'),
