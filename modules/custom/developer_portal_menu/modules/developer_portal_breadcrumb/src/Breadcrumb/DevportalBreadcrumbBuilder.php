...
namespace Drupal\developer_portal_breadcrumb\Breadcrumb;

use Drupal\Core\Breadcrumb\Breadcrumb;
use Drupal\Core\Breadcrumb\BreadcrumbBuilderInterface;
use Drupal\Core\Routing\RouteMatchInterface;
use Drupal\developer_portal_breadcrumb\Utility\BreadcrumbUtility;
...
class DevportalBreadcrumbBuilder implements BreadcrumbBuilderInterface, ContainerInjectionInterface {
   ...
   *
   * @var \Drupal\developer_portal_breadcrumb\Utility\BreadcrumbUtility
   */
   ...
   *   The request stack.
   * @param \Drupal\developer_portal_breadcrumb\Utility\BreadcrumbUtility $breadcrumb_utility
