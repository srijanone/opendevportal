...
namespace Drupal\opendevx_asyncapi\Plugin\Field\FieldFormatter;
...
class AsyncapiUIFormatter extends FileFormatterBase {
  ...
  public function view(FieldItemListInterface $items, $langcode = NULL) {
    ...
    $elements['#attached']['library'][] = 'opendevx_asyncapi/react_app';
    foreach ($this->getEntitiesToView($items, $langcode) as $file) {
      $asyncapi_file = file_create_url($file->getFileUri());
      $elements['#attached']['drupalSettings']['opendevx_asyncapi']['document'] = $asyncapi_file;
    }
    return $elements;
  }
