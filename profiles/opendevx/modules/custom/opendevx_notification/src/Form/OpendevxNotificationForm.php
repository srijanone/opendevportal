...
namespace Drupal\opendevx_notification\Form;
...
class OpendevxNotificationForm extends ConfigFormBase {
  ...
  protected function getEditableConfigNames() {
    return ['opendevx_notification.settings'];
  }
  ...
  public function getFormId() {
    return 'opendevx_notification_settings';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('opendevx_notification.settings');
    $form['workflow_type'] = [
      '#type' => 'fieldset',
  ...
  public function prepareWorkflowTypeForm($workflow, $config, $entityName) {
    ...
    $notification = $this->config('opendevx_notification.settings');
