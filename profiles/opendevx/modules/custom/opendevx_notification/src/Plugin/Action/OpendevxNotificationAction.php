...
namespace Drupal\opendevx_notification\Plugin\Action;

use Drupal\views_bulk_operations\Action\ViewsBulkOperationsActionBase;
use Drupal\Core\Session\AccountInterface;
use Drupal\Core\StringTranslation\StringTranslationTrait;
use Drupal\Core\Plugin\ContainerFactoryPluginInterface;
use Drupal\opendevx_notification\Services\OpendevxNotificationService;
 ...
 *
 * @Action(
 *   id = "opendevx_notification_bulk_action",
 *   label = @Translation("Read Notification"),
 *   type = "",
 * )
 */
class OpendevxNotificationAction extends ViewsBulkOperationsActionBase implements ContainerFactoryPluginInterface {
   ...
   *
   * @var \Drupal\opendevx_notification\Services\OpendevxNotificationService
   */
  protected $opendevx;
