...
class DownloadSdk extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build() {
    ...
    foreach ($nodes as $node) {
      $build[] = [
        'element_image' => [
          '#markup' => '<div class="product-image"><img src="' . ImageStyle::load('large')->buildUrl(
        ...
        'element_download' => [
          '#markup' => $this->renderer->render(\Drupal::formBuilder()->getForm('Drupal\opendevx_sdk\Form\DownloadSdk', $node->id())),
        ],
        '#cache' => [
          'max-age' => 0,
        ],
