...
namespace Drupal\opendevx_voyager\Plugin\Field\FieldFormatter;
...
class VoyagerUIFormatter extends FileFormatterBase {
  ...
  public function view(FieldItemListInterface $items, $langcode = NULL) {
    ...
    $elements['#attached']['library'][] = 'opendevx_voyager/graphQL_voyager';
    foreach ($this->getEntitiesToView($items, $langcode) as $file) {
      $voyager_file = file_create_url($file->getFileUri());
      $elements['#attached']['drupalSettings']['opendevx_voyager']['document'] = $voyager_file;
    }
    return $elements;
  }
