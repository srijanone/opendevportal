...
namespace Drupal\opendevx\Installer\Form;
...
class ModuleConfigureForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'opendevx_module_configure_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $modules = [
      [
        'id' => 'opendevx_demo',
        'label' => $this->t('Opendevx Demo Content'),
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $install_state[0]['opendevx_additional_modules'] = $installModules;
